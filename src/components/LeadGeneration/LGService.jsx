    ...
    >
      <div className="pt-[70px] md:pt-[102px] max-w-[786px] mx-auto pb-[100px] md:pb-[117px]">
        ...
        <div className="flex justify-center">
          <button
            className="w-[170px] h-[55px] hover:w-[190px] hover:h-[60px] md:w-[200px] md:h-[76px] md:hover:w-[288px] md:hover:h-[88px] duration-200 ease-linear border-[7px] md:!border-b-[8px] hover:border-b-[9px] border-x-[4px] border-t-[2px] border-primary rounded-[7px] md:rounded-[13.573px] bg-wp text-[#0D0D0D] capitalize text-[14px] md:text-[27.146px] font-semibold font-obviously-wide leading-normal mt-[36px] md:mt-[75px]"
            style={{
              leadingTrim: "both",
              textEdge: "cap",
              fontStyle: "italic",
